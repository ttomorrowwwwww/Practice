...
{
	uint32 port = 3;
	uint32 pinMDC = smi_MDC;
	uint32 pinMDIO = smi_MDIO;
	smiInit(port, pinMDC, pinMDIO);
	return SUCCESS;
}
...
int32 rtl8309n_vlan_init(void)
{
	...
	printf("rtl8309n_vlan_enable_set = %d m= %d\r\n", RTL8309N_ENABLED, m);
	rtl8309n_vlan_enable_get(&m);
	printf("rtl8309n_vlan_enable_get = %d \r\n", m);
